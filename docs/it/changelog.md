...
## In sviluppo — Avviso licenza (UI + docs)

### Aggiunto

- Pagine **[Licenza commerciale](reference/commercial-license.md)** (EN + IT) su GitHub Pages
- **Modal licenza** al primo avvio (bilingue) con link alla documentazione
- **`/settings/license`** nell'interfaccia web
- `license_info.py` — conferma salvata in `data/.sbobinator_license_ack.json`

---

## In sviluppo — Licenza proprietaria

### Modificato

- Licenza da MIT a **proprietaria** (uso personale gratuito; commerciale/aziendale a pagamento)
- Copyright **Antonio Trento** (antoniotrento.net) in tutti i file `.py`
- File `LICENSE`, `COPYRIGHT`, aggiornamento `pyproject.toml` e documentazione
