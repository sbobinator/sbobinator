...
Contribuendo codice o documentazione al repository, dichiari di avere i diritti necessari e accetti che il contributo, se accettato, sia integrato nel Software di proprietà di **Antonio Trento** secondo i termini della licenza in [`LICENSE`](../../LICENSE). Per contributi significativi può essere richiesto un accordo scritto.
