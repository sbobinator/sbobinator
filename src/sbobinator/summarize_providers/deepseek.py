"""Riassunto via DeepSeek API (OpenAI-compatible)."""
...
class DeepSeekProvider:
    ...
    def is_available(self) -> tuple[bool, str]:
        if not get_api_key(self.provider_id):
            return False, "Inserisci la API key DeepSeek in Impostazioni"
        return True, ""
    ...
    def complete(
        ...
        *,
        ...
        if on_progress:
            on_progress("summarize", 0.5, "Generazione riassunto (DeepSeek)...")
