#!/usr/bin/env python3
"""Scarica gsarti/it5-small-news-summarization in models/ (DEPRECATO — non usare)."""
...
def main() -> int:
    print(
        "DEPRECATO: IT5 non è più usato per il riassunto.\n"
        "  Qwen locale:  python scripts/download_summary_llm.py\n"
        "  Cloud API:    http://localhost:8501/settings/summary",
        file=sys.stderr,
    )
    return 1
